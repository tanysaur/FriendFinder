...
module.exports = function(app) {
  ...
  app.get("/api/friends", function(req, res){
    ...
    console.log("Displaying friends list" + res.json(friendsList[0]));
  });
